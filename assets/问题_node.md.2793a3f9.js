import{_ as s,c as a,o as n,d as l}from"./app.d912445c.js";const u=JSON.parse('{"title":"node相关问题","description":"","frontmatter":{},"headers":[],"relativePath":"问题/node.md","lastUpdated":1684846836000}'),e={name:"问题/node.md"},p=l(`<h1 id="node相关问题" tabindex="-1">node相关问题 <a class="header-anchor" href="#node相关问题" aria-hidden="true">#</a></h1><ol><li>开发依赖和生产依赖有什么区别？</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">**对于前端项目，没有任何区别**</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    ]</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="7"><li>tsc 命令处理不同配置文件 -p 或者 --project 可以指定tsconfig.json文件，但是无法处理单一文件，只能整个项目一起编译 创建一个tsconfig.build.json 文件，用于打包编译</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">tsc --p tsconfig.build.json</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,14),o=[p];function t(c,i,r,C,d,A){return n(),a("div",null,o)}const D=s(e,[["render",t]]);export{u as __pageData,D as default};
