import{_ as s,c as a,o as n,d as l}from"./app.54daa136.js";const u=JSON.parse('{"title":"node相关问题","description":"","frontmatter":{},"headers":[],"relativePath":"问题/node.md","lastUpdated":1684846836000}'),e={name:"问题/node.md"},p=l(`<h1 id="node相关问题" tabindex="-1">node相关问题 <a class="header-anchor" href="#node相关问题" aria-hidden="true">#</a></h1><ol><li>开发依赖和生产依赖有什么区别？</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">**对于前端项目，没有任何区别**</span></span>
