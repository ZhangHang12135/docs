...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="git-别名" tabindex="-1">git 别名 <a class="header-anchor" href="#git-别名" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">$ git config --global alias.co checkout</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,137),t=[p];function i(c,o,r,g,d,C){return n(),a("div",null,t)}const y=s(e,[["render",i]]);export{A as __pageData,y as default};
