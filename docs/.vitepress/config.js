        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                  ...
                  { text: '迭代器模式', link: '/设计模式/迭代器模式' },
                  { text: '观察者模式', link: '/设计模式/观察者模式' },
                  { text: '命令模式', link: '/设计模式/命令模式' },
                  { text: '组合模式', link: '/设计模式/组合模式' },
                  { text: '模板方法模式', link: '/设计模式/模板方法模式' },
                  { text: '享元模式', link: '/设计模式/享元模式' },
                ],
            },
            {
              text: '杂文',
